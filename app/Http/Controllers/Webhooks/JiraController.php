...
class JiraController extends WebhookBaseController
{
    public function handle(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $parser = new Jira(json_decode($request->getContent(), false));
            $message = $parser->parseMessage();

            if ($message !== '') {
                $target = $target ?: $this->getDefaultTarget('jira', $channel);
                ...
                $notification = new JiraNotification($message, $channel, $metadata);
